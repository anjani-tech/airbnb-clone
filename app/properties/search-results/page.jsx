...
const SearchResults = async ({ searchParams }) => {
  ...
  const propertiesQueryResuts = await Property.find(query).lean();
  const properties = convertToSerializableObject(propertiesQueryResuts);
  ...
  return (
    <>
      ...
      <section className="px-4 py-6">
        <div className="container-xl lg:container m-auto px-5 py-6">
          <Link
            href="/properties"
